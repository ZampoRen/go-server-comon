...
const file_api_proto_user_user_proto_rawDesc = "" +
	...
	"\x04page\x18\x03 \x01(\x05R\x04page\"U\n" +
	"\bUserInfo\x12\x17\n" +
	"\auser_id\x18\x01 \x01(\x03R\x06userId\x12\x1a\n" +
	"\busername\x18\x02 \x01(\tR\busername\x12\x14\n" +
	"\x05email\x18\x03 \x01(\tR\x05email2\xbd\x01\n" +
	"\x04User\x126\n" +
	...
	"\tListUsers\x12\x16.user.ListUsersRequest\x1a\x17.user.ListUsersResponseB Z\x1ego-server-comon/api/proto/userb\x06proto3"
